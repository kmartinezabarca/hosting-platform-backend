...
class NotificationController extends Controller
{
    ...
    public function broadcastToUsers(Request $request): JsonResponse
    {
        ...
        foreach ($users as $user) {
            $user->notify(new \App\Domains\Platform\Notifications\AdminBroadcast($notificationData));
        }
    ...
    public function sendToUser(Request $request, User $user): JsonResponse
    {
        ...
        $user->notify(new \App\Domains\Platform\Notifications\AdminDirect($notificationData));
