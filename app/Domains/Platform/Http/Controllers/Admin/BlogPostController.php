...
class BlogPostController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        if ($request->has('category_id')) {
            ...
            $cat = \App\Domains\Platform\Models\BlogCategory::where('uuid', $request->category_id)->first();
            if ($cat) {
    ...
    public function store(BlogPostRequest $request): JsonResponse
    {
        ...
        $category = \App\Domains\Platform\Models\BlogCategory::where("uuid", $data["blog_category_id"])->firstOrFail();
